...
const DEFAULT_FOOTER = {
  logoText: 'Saas',
  companyDescription:
    'Empowering businesses with cutting-edge SaaS solutions. From workflow automation to data analytics, we help companies scale efficiently and drive growth through intelligent software.',
  contactEmail: 'hello@saas.com',
  contactPhone: '+1 (555) 847-2901',
  contactAddress: '2847 Innovation Drive, Tech Hub 200',
  newsletterTitle: 'Product Updates',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer: 'Get feature updates, tips, and industry insights. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 Saas. All rights reserved.',
  madeWithText: 'by our team',
  socialText: 'Follow us:',
  social1Href: 'https://twitter.com/saasplatform',
  social2Href: 'https://facebook.com/saasplatform',
  social3Href: 'https://instagram.com/saasplatform',
  social4Href: 'https://linkedin.com/company/saasplatform',
  social5Href: 'https://github.com/saasplatform',
} as const;
