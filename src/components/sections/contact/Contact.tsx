...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Connect with our warehouse management experts to see how our ERP solution with RFID gun integration can streamline your inventory processes and boost operational efficiency.',
  formTitle: 'Request a Demo',
  formDescription:
    'Fill out the form below and our team will schedule a personalized demo within 24 hours.',
  ...
  supportNote: '24/7 system monitoring and critical support for all Enterprise clients',
  nameLabel: 'Full Name *',
  namePlaceholder: 'John Smith',
  emailLabel: 'Business Email *',
  emailPlaceholder: 'john@yourcompany.com',
  companyLabel: 'Company Name *',
  companyPlaceholder: 'Your Warehouse Company',
  messageLabel: 'Tell Us About Your Warehouse *',
  messagePlaceholder:
    'Describe your current inventory challenges, warehouse size, daily volume, and specific RFID requirements...',
} as const;
